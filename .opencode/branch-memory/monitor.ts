...
export class BranchMonitor {
  ...
  private changeCallbacks: Array<(oldBranch: string | undefined, newBranch: string) => void> = []
  private isMonitoring = false
  
  constructor(
    private onBranchChange: (oldBranch: string | undefined, newBranch: string) => void,
  ...
  async start(): Promise<void> {
    ...
    // Get current branch
    this.currentBranch = await GitOperations.getCurrentBranch()
   ...
   */
  onChange(callback: (oldBranch: string | undefined, newBranch: string) => void): void {
   ...
   */
  offChange(callback: (oldBranch: string | undefined, newBranch: string) => void): void {
